...
typedef OnTap = void Function(MFSnackBar snack);
typedef OnHover = void Function(
    MFSnackBar snack, SnackHoverState snackHoverState);

typedef SnackBarStatusCallback = void Function(SnackBarStatus? status);

class MFSnackBar extends StatefulWidget {
  ...
  @override
  State createState() => MFSnackBarState();
}

class MFSnackBarState extends State<MFSnackBar> with TickerProviderStateMixin {
